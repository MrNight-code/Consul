...
| Método | Ruta                                | Descripción                          |
| :----- | :---------------------------------- | :----------------------------------- |
| `POST` | `/api/cobranzas/{id}/generar-recibo` | Genera y congela el recibo PDF.      |

#### Listar Recibos

| Método | Ruta                   | Descripción                           |
| :----- | :--------------------- | :------------------------------------ |
| `GET`  | `/api/cobranzas/recibos` | Lista recibos generados con filtros. |

#### Descargar Recibo

| Método | Ruta                            | Descripción              |
| :----- | :------------------------------ | :----------------------- |
| `GET`  | `/api/cobranzas/recibos/{filename}` | Descarga el archivo PDF. |
